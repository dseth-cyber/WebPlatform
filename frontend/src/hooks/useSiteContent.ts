...
export const DEFAULT_SITE_SETTINGS: SiteContentSettings = {
  ...
  logoText: 'LC',
  companyNameTh: 'บริษัท โลหะกิจรุ่งเจริญทรัพย์ จำกัด',
  companyNameEn: 'LOHAKIT RUNGCHAROENSAP CO., LTD.',
  logoIcon: 'LC',
  showCMSButton: true,
  ...
  heroTitle: 'โลหะกิจรุ่งเจริญทรัพย์',
  heroHighlight: 'บรรจุภัณฑ์โลหะระดับโลก',
  heroSubtitle:
