...
export const PrivacyPage: React.FC = () => (
  <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8 font-sans">
    ...
    <div className="prose prose-invert prose-sm text-theme-text-muted space-y-4 leading-relaxed">
      <p>
        บริษัท ไคโอทรอน เทคโนโลยี จำกัด (CHIOTRON TECHNOLOGY CO., LTD.) ตระหนักถึงความสำคัญของการคุ้มครองข้อมูลส่วนบุคคลตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (PDPA)
      </p>
...
export const TermsPage: React.FC = () => (
  <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8 font-sans">
    ...
    <div className="prose prose-invert prose-sm text-theme-text-muted space-y-4 leading-relaxed">
      <p>
        ข้อมูลจำเพาะทางเทคนิค ภาพผลิตภัณฑ์ และเอกสารสเปกชีตทั้งหมดบนเว็บไซต์นี้เป็นทรัพย์สินทางปัญญาของ บริษัท ไคโอทรอน เทคโนโลยี จำกัด (CHIOTRON TECHNOLOGY CO., LTD.) ห้ามทำซ้ำหรือดัดแปลงโดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษร
      </p>
    </div>
  </div>
);
