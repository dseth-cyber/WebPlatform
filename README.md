...
ระบบถูกออกแบบให้ **Portable 100%** สามารถนำไปติดตั้งใช้งานบนเครื่องคอมพิวเตอร์หรือเซิร์ฟเวอร์เครื่องอื่นได้อย่างง่ายดาย โดยมีไฟล์ Static Assets สำหรับ Production (`frontend/dist/`) พร้อมใช้งานในตัว ทำให้ **ไม่จำเป็นต้องติดตั้ง Node.js, Go หรือเครื่องมือ Build ใดๆ บนเครื่องปลายทาง** เพียงแค่มี **Docker Desktop** เท่านั้น
